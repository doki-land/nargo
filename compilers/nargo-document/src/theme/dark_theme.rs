...
use super::{
    Theme,
    default_theme::{LocaleInfo, NavItem, PageContext, SidebarGroup, SidebarLink, ToNargoValue},
};
...
impl DarkTheme {
    ...
    pub fn new(config: Config) -> Result<Self, Box<dyn std::error::Error>> {
        let template_path = Path::new(env!("CARGO_MANIFEST_DIR")).join("templates").join("dark_page.html");
